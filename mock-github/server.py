...
def get_mock_user():
    ...
    return {
        ...
        "email": os.getenv("MOCK_USER_EMAIL", "tom@sapletta.com"),
        "avatar_url": os.getenv("MOCK_USER_AVATAR_URL", "https://avatars.githubusercontent.com/u/5669315?v=4"),
        "html_url": f"https://github.com/{os.getenv('MOCK_USER_LOGIN', 'tom-sapletta-com')}",
        "type": "User",
        "bio": os.getenv("MOCK_USER_BIO", "Architect & Developer"),
        "company": os.getenv("MOCK_USER_COMPANY", "Softreck"),
        "location": os.getenv("MOCK_USER_LOCATION", "Gdańsk, Poland"),
        "public_repos": int(os.getenv("MOCK_USER_PUBLIC_REPOS", "150")),
        "created_at": "2013-10-14T12:00:00Z",
        "updated_at": "2025-01-01T00:00:00Z",
    }

MOCK_USERS = {
    os.getenv("MOCK_USER_LOGIN", "tom-sapletta-com"): get_mock_user()
}

# Get user login for consistent repository mapping
USER_LOGIN = os.getenv("MOCK_USER_LOGIN", "tom-sapletta-com")

MOCK_REPOS = {
    USER_LOGIN: [
        {"id": 1, "name": "semcod", "full_name": f"{USER_LOGIN}/semcod", "private": False,
         "description": "Semantic Code Analysis", "language": "Python", "default_branch": "main",
         "html_url": f"https://github.com/{USER_LOGIN}/semcod",
         "clone_url": f"https://github.com/{USER_LOGIN}/semcod.git"},
        {"id": 2, "name": "letwhisper", "full_name": f"{USER_LOGIN}/letwhisper", "private": False,
         "description": "Speech-to-text tool", "language": "Python", "default_branch": "main",
         "html_url": f"https://github.com/{USER_LOGIN}/letwhisper",
         "clone_url": f"https://github.com/{USER_LOGIN}/letwhisper.git"},
        {"id": 3, "name": "dialogware", "full_name": f"{USER_LOGIN}/dialogware", "private": True,
         "description": "Dialog platform", "language": "JavaScript", "default_branch": "main",
         "html_url": f"https://github.com/{USER_LOGIN}/dialogware",
         "clone_url": f"https://github.com/{USER_LOGIN}/dialogware.git"},
    ]
}
