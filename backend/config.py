...
STRIPE_PRICE_ANALYSIS_PER_PR = int(
    os.getenv("STRIPE_PRICE_ANALYSIS_PER_PR", "50")
)  # $0.50
STRIPE_PRICE_AUTOFIX_PER_RUN = int(
    os.getenv("STRIPE_PRICE_AUTOFIX_PER_RUN", "100")
)  # $1.00
STRIPE_PRICE_REPO_ACTIVE_MONTHLY = int(
    os.getenv("STRIPE_PRICE_REPO_ACTIVE_MONTHLY", "200")
)  # $2.00
