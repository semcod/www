...
import { gradeColor } from "../../lib/config";
  ...
  return (
    <div style={{ position: "relative", width: size, height: size, flexShrink: 0 }}>
      <svg width={size} height={size} style={{ transform: "rotate(-90deg)" }}>
        <circle cx={size / 2} cy={size / 2} r={r} fill="none" stroke="#131d30" strokeWidth="5" />
      ...
      <div style={{
        ...
        <span style={{ fontSize: size * 0.13, color: "#8899b4", marginTop: 3, fontFamily: "'JetBrains Mono', monospace" }}>{score}/100</span>
      </div>
    </div>
  );
}
